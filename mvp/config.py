...
model_3d_examples = {
    ...
    "car_side": np.array([0,0,0,4.4,2.1,1.6,0]),
    "car_side_1": np.array([0,0,0,4.4,2.2,1.6,0]),
    "car_side_2": np.array([0,0,0,4.4,2.2,1.6,0]),
    "car_side_3": np.array([0,0,0,4.4,2.2,1.6,0]),
    "car_side_4": np.array([0,0,0,4.4,2.2,1.6,0]),
    "car_side_5": np.array([0,0,0,4.4,2.2,1.6,0]),
    "car_side_5_with_plane": np.array([0,0,0,4.4,2.2,1.6,0]),
    "car_side_6": np.array([0,0,0,4.4,2.2,1.6,0]),
    "car_side_7": np.array([0,0,0,4.4,1.6,1.6,0]),
    "car_side_8": np.array([0,0,0,4.4,1.2,1.6,0]),
    "car_side_9": np.array([0,0,0,4.4,1.0,1.6,0]),
    "adv_car_side_8_non_victim": np.array([0,0,0,4.5,1.3,1.7,0]),
    "two_planes_0": np.array([0,0,0,4.4,2.0,1.6,0]),
    "two_planes_10": np.array([0,0,0,4.4,2.0,1.6,0]),
    "car_10": np.array([0,0,0,4.4,2.0,1.6,0]),
    "real_car_random": np.array([0,0,0,4.4,2.2,1.6,0]),
    "real_car": np.array([0,0,0,4.4,2.2,1.6,0]),
    ...
    "cuboid": np.array([0,0,0,4.4,2.2,1.6,0]),
}
